        ...
        <div class="container-fluid py-5 bg-secondary" >
            ...
            <div class="row justify-content-center">
                <div class="col-12 bg-dark d-flex align-items-center">
                    <div class="p-5 w-100">
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">Thể Loại Đồ Uống</h5>
                        <h1 class="text-white mb-4">Thể Loại Đồ Uống</h1>
                        <div class="table-responsive">
                            ...
                            <button class="btn btn-primary" data-toggle="modal" data-target="#addCategoryModal">Thêm Thể Loại</button>    
                                                        ...
                                                        <div class="modal-content">
                                                            <form action="drink-category" method="post">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label>Tên Thể Loại</label>
                                                                        <input type="text" id="categoryName" name="categoryName" pattern=".*\S.*" title="Không được chỉ nhập khoảng trắng" value="${category.categoryName}" class="form-control" required>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
