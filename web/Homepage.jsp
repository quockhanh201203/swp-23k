...
<html lang="en">
    ...
    <body>
        ...
        <div id="popupBanner">
            <div class="popup-content">
                ...
                <p>Chương trình mới của cửa hàng</p>
            </div>
        </div>
        ...
        <div id="popupTable">
            <div class="popup-content">
                ...
                <button class="btn btn-primary py-2 px-4" type="submit">Xác nhận bàn</button>
            </form>                </div>
            </div>
        </div>  
    ...
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h1 class="mb-5">Bán chạy nhất</h1>
        </div>
        ...
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h1 class="mb-5">Ăn thả ga không lo về giá</h1>
        </div>
