                            ...
                            <form action="ingredient" method="post">
                                ...
                                <div class="modal-body">					
                                    <div class="form-group">
                                         ...
                                         <label for="ingredients">Food Name</label>
                <select id="ingredients" name="foodname">
        ...
        <script>
            $('#deleteIngredient').on('show.bs.modal', function (event) {
                var button = $(event.relatedTarget); // Nút mà người dùng nhấn để mở modal
                var foodID = button.data('id'); // Lấy giá trị foodID từ thuộc tính data-id

                var modal = $(this);
                modal.find('input[name="foodID"]').val(foodID); // Cập nhật giá trị foodID trong form của modal
            });
        </script>
        <script>
